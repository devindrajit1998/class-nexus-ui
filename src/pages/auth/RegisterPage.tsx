...
import { EyeIcon, EyeOffIcon, Mail, Lock, User, LogIn } from "lucide-react";
      ...
      <Card className="mx-auto w-full max-w-md">
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-center text-sm text-slate-500">
            ...
            <Link to="/auth/login" className="underline underline-offset-4 hover:text-slate-900 dark:hover:text-slate-50">
              Sign in
            </Link>
          </div>
        </CardFooter>
